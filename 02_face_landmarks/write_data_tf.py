...
landmark_path_data = "/Users/chenxuzhuang/faceAttr/dataset/300W_LP/landmarks"
...
for idx in range(landmark_anno_list.__len__()):
    ...
    #     cv2.circle(face_data, (int(im_point[p*2]*sp[1]), int(im_point[p*2 + 1]*sp[0])), 2, (0,255,0), 2)
