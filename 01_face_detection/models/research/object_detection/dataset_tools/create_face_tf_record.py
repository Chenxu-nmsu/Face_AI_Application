...
Example usage:
    python3 object_detection/dataset_tools/create_face_tf_record.py \
        --data_dir=/Users/chenxuzhuang/faceRecognition \
        --year=widerface \
        --output_path=/Users/chenxuzhuang/faceRecognition/TF-data/test.record \
        --set=test
"""
...
flags.DEFINE_string('label_map_path',
                    '/Users/chenxuzhuang/faceRecognition/widerface/models/research/object_detection/data/face_label_map.pbtxt', ##修改为真实的路径
