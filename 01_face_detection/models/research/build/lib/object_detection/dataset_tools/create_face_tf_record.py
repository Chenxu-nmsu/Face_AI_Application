...
Example usage:
    python3 object_detection/dataset_tools/create_face_tf_record.py \
        --data_dir=/Users/chenxuzhuang/Onedrive files/Onedrive files/OneDrive - New Mexico State University/2020/Fall 2020/ML Projects \
        --year=widerface \
        --output_path=/Users/chenxuzhuang/Onedrive files/Onedrive files/OneDrive - New Mexico State University/2020/Fall 2020/ML Projects/TF-data/train.record \
        --set=train
"""
...
flags.DEFINE_string('label_map_path',
                    'models/research/object_detection/data/face_label_map.pbtxt', ##修改为真实的路径
