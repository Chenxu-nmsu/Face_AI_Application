            ...
            wx.uploadFile({
              ...
              success: function (res) {
                ...
                wx.request({
                  ...
                  success: function (res) {
                    var pos = res.data
                    pos[0] = parseInt(pos[0]/256 * windowWidth)
                    pos[1] = parseInt(pos[1]/256 * windowHeight * 0.6)
                    pos[2] = parseInt(pos[2]/256 * windowWidth)
                    pos[3] = parseInt(pos[3]/256 * windowHeight * 0.6)
                    that.setData({
                      x1: pos[0],
                      y1: pos[1],
                      x2: pos[2],
